...
export function DashboardSidebar({ companies }: DashboardSidebarProps) {
  ...
  return (
    <aside className="flex h-full w-72 flex-col border-r border-white/10 bg-gradient-to-b from-slate-900/95 via-slate-900/90 to-slate-800/95 backdrop-blur-xl">
      {/* Logo/Brand */}
      <div className="flex flex-col gap-4 border-b border-white/10 bg-gradient-to-r from-blue-600/10 via-purple-600/10 to-pink-600/10 p-6">
        <div className="flex items-center gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 via-purple-600 to-pink-600 shadow-lg shadow-purple-500/30 ring-2 ring-white/20">
